...
// class MainComponent extends React.Component<MapPropsType & DispatchPropsType> {
...
//   compose<ComponentType>(withRouter, connect(mapStateToProps, { initializeApp }))(MainComponent);
